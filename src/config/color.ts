...
export const COLOR_TOKEN: TColorSeries = {
  DEFAULT: {
    '--td-brand-color': '#0c72fc',
    '--td-brand-color-1': '#deecff',
    '--td-brand-color-2': '#bcd9fe',
    '--td-brand-color-3': '#9ac7fe',
    '--td-brand-color-4': '#78b4fd',
    '--td-brand-color-5': '#55a0fd',
    '--td-brand-color-6': '#1e81fc',
    '--td-brand-color-7': '#0c72fc',
    '--td-brand-color-8': '#025de9',
    '--td-brand-color-9': '#014bcd',
    '--td-brand-color-10': '#013ab0',
  },
